...
test('async hooks', TEST_PARAMS, async t => {
  // t.plan(21)
  ...
  await toPromise(resolve => {
    sget({
      ...
      assert.strict(JSON.parse(body), { hello: 'world' })
      resolve()
    })
  })
...
//     assert.ok('onSend called')
//     assert.same(JSON.parse(thePayload), payload)
//     return thePayload.replace('world', 'modified')
//   })

//   fastify.addHook('onSend', async function (request, reply, thePayload) {
//     assert.ok('onSend called')
//     assert.same(JSON.parse(thePayload), modifiedPayload)
//     return anotherPayload
//   })

//   fastify.addHook('onSend', async function (request, reply, thePayload) {
//     assert.ok('onSend called')
//     assert.equal(thePayload, anotherPayload)
//   })
...
//   }, (err, res) => {
//     assert.error(err)
//     assert.equal(res.payload, anotherPayload)
//     assert.equal(res.statusCode, 200)
//     assert.equal(res.headers['content-length'], '18')
//   })
// })

// test('onRequest hooks should be able to block a request', TEST_PARAMS, t => {
//   t.plan(5)
//   const fastify = Fastify()
...
// test('preParsing hooks should be able to modify the payload', TEST_PARAMS, t => {
//   t.plan(3)
//   const fastify = Fastify()
...
//     assert.error(err)
//     assert.equal(res.statusCode, 200)
//     assert.same(JSON.parse(res.payload), { hello: 'another world' })
//   })
// })

// test('preParsing hooks should be able to supply statusCode', TEST_PARAMS, t => {
//   t.plan(4)
//   const fastify = Fastify()
...
//     assert.same(JSON.parse(res.payload), {
//       statusCode: 408,
...
// test('preParsing hooks should ignore statusCode 200 in stream error', TEST_PARAMS, t => {
//   t.plan(4)
//   const fastify = Fastify()
...
// test('preParsing hooks should ignore non-number statusCode in stream error', TEST_PARAMS, t => {
//   t.plan(4)
//   const fastify = Fastify()
...
// test('preParsing hooks should default to statusCode 400 if stream error', TEST_PARAMS, t => {
//   t.plan(4)
//   const fastify = Fastify()
...
// test('preParsing hooks should handle errors', TEST_PARAMS, t => {
//   t.plan(3)
//   const fastify = Fastify()
...
// test('preHandler hooks should be able to block a request', TEST_PARAMS, t => {
//   t.plan(5)
//   const fastify = Fastify()
...
// test('preValidation hooks should be able to block a request', TEST_PARAMS, t => {
//   t.plan(5)
//   const fastify = Fastify()
...
// test('preValidation hooks should be able to change request body before validation', TEST_PARAMS, t => {
//   t.plan(4)
//   const fastify = Fastify()
...
// test('preSerialization hooks should be able to modify the payload', TEST_PARAMS, t => {
//   t.plan(3)
//   const fastify = Fastify()
...
// test('preSerialization hooks should handle errors', TEST_PARAMS, t => {
//   t.plan(3)
//   const fastify = Fastify()
...
// test('preValidation hooks should handle throwing null', TEST_PARAMS, t => {
//   t.plan(4)
//   const fastify = Fastify()
...
// test('preValidation hooks should handle throwing a string', TEST_PARAMS, t => {
//   t.plan(3)
//   const fastify = Fastify()
...
// test('onRequest hooks should be able to block a request (last hook)', TEST_PARAMS, t => {
//   t.plan(5)
//   const fastify = Fastify()
...
// test('preHandler hooks should be able to block a request (last hook)', TEST_PARAMS, t => {
//   t.plan(5)
//   const fastify = Fastify()
...
// test('onRequest respond with a stream', TEST_PARAMS, t => {
//   t.plan(4)
//   const fastify = Fastify()
...
// test('preHandler respond with a stream', TEST_PARAMS, t => {
//   t.plan(7)
//   const fastify = Fastify()
...
// test('Should log a warning if is an async function with `done`', TEST_PARAMS, t => {
...
// test('early termination, onRequest async', TEST_PARAMS, async t => {
//   t.plan(2)
...
// test('The this should be the same of the encapsulation level', TEST_PARAMS, async t => {
//   const fastify = Fastify()
...
// test('preSerializationEnd should handle errors if the serialize method throws', TEST_PARAMS, t => {
...
// t.test('nested hooks to do not crash on 404', TEST_PARAMS, t => {
//   t.plan(2)
//   const fastify = Fastify()
...
// test('Register an hook (preHandler) as route option should fail if mixing async and callback style', TEST_PARAMS, t => {
//   t.plan(2)
//   const fastify = Fastify()
...
// test('Register an hook (onSend) as route option should fail if mixing async and callback style', TEST_PARAMS, t => {
//   t.plan(2)
//   const fastify = Fastify()
...
// test('Register an hook (preSerialization) as route option should fail if mixing async and callback style', TEST_PARAMS, t => {
//   t.plan(2)
//   const fastify = Fastify()
...
// test('Register an hook (onError) as route option should fail if mixing async and callback style', TEST_PARAMS, t => {
//   t.plan(2)
//   const fastify = Fastify()
...
// test('Register an hook (preParsing) as route option should fail if mixing async and callback style', TEST_PARAMS, t => {
//   t.plan(2)
//   const fastify = Fastify()
...
// test('Register an hook (onRequestAbort) as route option should fail if mixing async and callback style', TEST_PARAMS, t => {
//   t.plan(2)
//   const fastify = Fastify()
